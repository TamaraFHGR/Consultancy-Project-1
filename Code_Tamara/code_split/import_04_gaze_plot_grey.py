...
def update_gaze_plot_grey(selected_city):
    if selected_city:
        ...
        fig.add_layout_image(
            dict(
                ...
                yref="y",
                sizing="contain",
                # Das Bild wird so skaliert, dass es komplett sichtbar ist, ohne gestreckt zu werden
                opacity=0.6,
                layer="below"
            )
        )
...
print(update_gaze_plot_grey('Antwerpen_S1'))
